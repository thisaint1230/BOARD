...
import com.example.Util.JAVAUtil;
...
public class BoardDAO {
    ...
    public int updateBoard(BoardVO vo) {
        ...
        try {
            ...
            stmt.setString(3, vo.getContent());
            stmt.setString(4,vo.getCategory());
            stmt.setString(5, vo.getEditdate());
            stmt.setInt(6, vo.getSeq());

            System.out.println(vo.getTitle() + "-" + vo.getWriter() + "-" + vo.getContent() + "-" + vo.getSeq()+ "-" +vo.getCategory()+"-" +vo.getEditdate());
            stmt.executeUpdate();
            return 1;
